const translations = {
  en: {
    ...
    donate: "Donate",
    tagline: "Personal Intro Website",
    heroTitle: "Hi, I'm Abena. I am building something meaningful with Koda.",
    heroLead:
    ...
    whyText:
      "I wanted one simple place where anyone can understand the vision behind Koda and connect with me directly.",
    ...
    footerText: "Built with intention by Abena."
  },
  de: {
    title: "Abena | Ich entwickle Koda",
    languageLabel: "Sprache",
    navAbout: "Über mich",
    navProject: "Projekt",
    navSupport: "Support",
    donate: "Spenden",
    tagline: "Persönliche Vorstellungswebsite",
    heroTitle: "Hi, ich bin Abena. Ich baue mit Koda etwas Bedeutungsvolles.",
    heroLead:
      "Auf dieser Website zeige ich, wer ich bin, was ich entwickle und warum mir dieses Projekt wichtig ist. Wenn du neugierig auf meine Reise bist, bist du hier genau richtig.",
    ctaProject: "Projekt ansehen",
    ctaAbout: "Lerne mich kennen",
    whyTitle: "Warum diese Seite?",
    whyText:
      "Ich wollte einen einfachen Ort schaffen, an dem alle die Vision hinter Koda verstehen und direkt mit mir in Kontakt treten können.",
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Mit viel Absicht von Abena gebaut."
  },
  fr: {
    title: "Abena | Construire Koda",
    languageLabel: "Langue",
    navAbout: "À propos",
    navProject: "Projet",
    navSupport: "Soutien",
    donate: "Donner",
    tagline: "Site de présentation personnelle",
    heroTitle: "Bonjour, je suis Abena. Je construis quelque chose de fort avec Koda.",
    heroLead:
      "Ce site présente qui je suis, ce que je construis et pourquoi ce projet compte pour moi. Si vous êtes curieux de suivre mon parcours, vous êtes au bon endroit.",
    ctaProject: "Voir le projet",
    ctaAbout: "Me découvrir",
    whyTitle: "Pourquoi cette page ?",
    whyText:
      "Je voulais un espace simple où chacun peut comprendre la vision de Koda et me contacter directement.",
    githubButton: "Profil GitHub",
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Construit avec intention par Abena."
  },
  it: {
    title: "Abena | Costruendo Koda",
    languageLabel: "Lingua",
    navAbout: "Chi sono",
    navProject: "Progetto",
    navSupport: "Supporto",
    donate: "Dona",
    tagline: "Sito personale di presentazione",
    heroTitle: "Ciao, sono Abena. Sto costruendo qualcosa di importante con Koda.",
    heroLead:
      "Questo sito racconta chi sono, cosa sto creando e perché questo progetto è importante per me. Se vuoi seguire il mio percorso, sei nel posto giusto.",
    ctaProject: "Scopri il progetto",
    ctaAbout: "Conosciamoci",
    whyTitle: "Perché questa pagina?",
    whyText:
      "Volevo un luogo semplice in cui chiunque possa capire la visione di Koda e connettersi direttamente con me.",
    githubButton: "Profilo GitHub",
    aboutTitle: "Chi sono",
    aboutText:
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Creato con intenzione da Abena."
  },
  es: {
    title: "Abena | Construyendo Koda",
    languageLabel: "Idioma",
    navAbout: "Sobre mí",
    navProject: "Proyecto",
    navSupport: "Apoyo",
    donate: "Donar",
    tagline: "Sitio personal de presentación",
    heroTitle: "Hola, soy Abena. Estoy construyendo algo valioso con Koda.",
    heroLead:
      "Este sitio muestra quién soy, qué estoy creando y por qué este proyecto es importante para mí. Si quieres conocer mi camino, este es tu lugar.",
    ctaProject: "Ver el proyecto",
    ctaAbout: "Conóceme",
    whyTitle: "¿Por qué esta página?",
    whyText:
      "Quería un lugar simple donde cualquiera pudiera entender la visión de Koda y conectar conmigo directamente.",
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Creado con intención por Abena."
  },
  pt: {
    title: "Abena | Construindo Koda",
    languageLabel: "Idioma",
    navAbout: "Sobre",
    navProject: "Projeto",
    navSupport: "Apoio",
    donate: "Doar",
    tagline: "Site pessoal de apresentação",
    heroTitle: "Oi, eu sou a Abena. Estou construindo algo significativo com Koda.",
    heroLead:
      "Este site mostra quem eu sou, o que estou criando e por que este projeto é importante para mim. Se você quer acompanhar minha jornada, você está no lugar certo.",
    ctaProject: "Ver o projeto",
    ctaAbout: "Conheça-me",
    whyTitle: "Por que esta página?",
    whyText:
      "Eu queria um lugar simples onde qualquer pessoa pudesse entender a visão do Koda e se conectar comigo diretamente.",
    githubButton: "Perfil no GitHub",
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Feito com intenção por Abena."
  },
  ru: {
    title: "Abena | Создаю Koda",
    languageLabel: "Язык",
    navAbout: "Обо мне",
    navProject: "Проект",
    navSupport: "Поддержка",
    donate: "Донат",
    tagline: "Личный сайт-презентация",
    heroTitle: "Привет, я Abena. Я создаю что-то важное вместе с Koda.",
    heroLead:
      "На этом сайте я рассказываю, кто я, что создаю и почему этот проект важен для меня. Если вам интересен мой путь, вы в правильном месте.",
    ctaProject: "Смотреть проект",
    ctaAbout: "Узнать обо мне",
    whyTitle: "Зачем эта страница?",
    whyText:
      "Я хотела создать одно простое место, где каждый сможет понять видение Koda и связаться со мной напрямую.",
    githubButton: "Профиль GitHub",
    aboutTitle: "Обо мне",
    aboutText:
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Создано с намерением от Abena."
  },
  ar: {
    title: "Abena | Building Koda",
    languageLabel: "اللغة",
    ...
    navSupport: "الدعم",
    donate: "تبرع",
    tagline: "موقع تعريفي شخصي",
    heroTitle: "مرحبا، أنا أبينا. أبني شيئا مهما مع Koda.",
    heroLead:
      "هذا الموقع يوضح من أنا، وماذا أبني، ولماذا هذا المشروع مهم بالنسبة لي. إذا كنت مهتما برحلتي فأنت في المكان الصحيح.",
    ctaProject: "عرض المشروع",
    ctaAbout: "تعرف علي",
    whyTitle: "لماذا هذه الصفحة؟",
    whyText:
      "أردت مكانا بسيطا يستطيع أي شخص من خلاله فهم رؤية Koda والتواصل معي مباشرة.",
    githubButton: "حساب GitHub",
    aboutTitle: "من أنا",
    aboutText:
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "تم البناء بعناية بواسطة أبينا."
  },
  hi: {
    title: "Abena | Koda बना रही हूं",
    languageLabel: "भाषा",
    navAbout: "मेरे बारे में",
    navProject: "प्रोजेक्ट",
    navSupport: "सपोर्ट",
    donate: "डोनेट",
    tagline: "व्यक्तिगत परिचय वेबसाइट",
    heroTitle: "हाय, मैं Abena हूं। मैं Koda के साथ कुछ अर्थपूर्ण बना रही हूं।",
    heroLead:
      "इस वेबसाइट पर मैं बताती हूं कि मैं कौन हूं, क्या बना रही हूं और यह प्रोजेक्ट मेरे लिए क्यों महत्वपूर्ण है। अगर आप मेरी यात्रा जानना चाहते हैं, तो आप सही जगह पर हैं।",
    ctaProject: "प्रोजेक्ट देखें",
    ctaAbout: "मुझे जानें",
    whyTitle: "यह पेज क्यों?",
    whyText:
      "मैं एक ऐसी सरल जगह चाहती थी जहां कोई भी Koda की vision समझ सके और सीधे मुझसे जुड़ सके।",
    githubButton: "GitHub प्रोफाइल",
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Abena द्वारा इरादे के साथ बनाया गया।"
  },
  zh: {
    title: "Abena | 构建 Koda",
    languageLabel: "语言",
    ...
    donate: "捐赠",
    tagline: "个人介绍网站",
    heroTitle: "你好，我是 Abena。我正在用 Koda 打造有意义的东西。",
    heroLead:
      "这个网站介绍我是谁、我在做什么，以及为什么这个项目对我很重要。如果你想了解我的旅程，这里就是最好的地方。",
    ctaProject: "查看项目",
    ctaAbout: "了解我",
    whyTitle: "为什么做这个页面？",
    whyText:
      "我想要一个简单的地方，让任何人都能理解 Koda 的愿景，并直接与我联系。",
    githubButton: "GitHub 主页",
    aboutTitle: "关于我",
    aboutText:
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "由 Abena 用心打造。"
  },
  ja: {
    title: "Abena | Koda を開発中",
    languageLabel: "言語",
    navAbout: "私について",
    navProject: "プロジェクト",
    navSupport: "サポート",
    donate: "寄付",
    tagline: "自己紹介サイト",
    heroTitle: "こんにちは、Abena です。Koda で意味のあるものを作っています。",
    heroLead:
      "このサイトでは、私が誰で、何を作っていて、なぜこのプロジェクトが大切なのかを紹介します。私の挑戦に興味があれば、ぜひ見てください。",
    ctaProject: "プロジェクトを見る",
    ctaAbout: "私を知る",
    whyTitle: "なぜこのページ？",
    whyText:
      "誰でも Koda のビジョンを理解し、私と直接つながれるシンプルな場所を作りたかったからです。",
    githubButton: "GitHub プロフィール",
    aboutTitle: "私について",
    aboutText:
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Abena が想いを込めて制作。"
  },
  ko: {
    title: "Abena | Koda 개발 중",
    languageLabel: "언어",
    navAbout: "소개",
    navProject: "프로젝트",
    navSupport: "후원",
    donate: "기부",
    tagline: "개인 소개 웹사이트",
    heroTitle: "안녕하세요, 저는 Abena입니다. Koda로 의미 있는 것을 만들고 있어요.",
    heroLead:
      "이 웹사이트는 제가 누구인지, 무엇을 만들고 있는지, 왜 이 프로젝트가 중요한지를 소개합니다. 제 여정이 궁금하다면 여기가 맞는 곳입니다.",
    ctaProject: "프로젝트 보기",
    ctaAbout: "나에 대해 보기",
    whyTitle: "왜 이 페이지인가요?",
    whyText:
      "누구나 Koda의 비전을 이해하고 저와 직접 연결될 수 있는 간단한 공간을 만들고 싶었습니다.",
    githubButton: "GitHub 프로필",
    aboutTitle: "저에 대해",
    aboutText:
    ...
    coffeeButton: "Buy Me a Coffee",
    footerText: "Abena가 진심을 담아 만들었습니다."
  }
};
...
const applyLanguage = (lang) => {
  const safeLang = translations[lang] ? lang : defaultLang;
  const dict = translations[safeLang];
  const defaultDict = translations[defaultLang];

  document.documentElement.lang = safeLang;
  document.documentElement.dir = rtlLanguages.has(safeLang) ? "rtl" : "ltr";
  document.title = dict.title || defaultDict.title;

  document.querySelectorAll("[data-i18n]").forEach((node) => {
    const key = node.getAttribute("data-i18n");
    const value = dict[key] || defaultDict[key];
    if (value) {
  ...
  if (languageSelect) {
    languageSelect.setAttribute(
      "aria-label",
      dict.languageLabel || defaultDict.languageLabel
    );
    languageSelect.value = safeLang;
  }
};

const savedLanguage = localStorage.getItem("koda-language");
const initialLanguage =
  savedLanguage || (navigator.language || defaultLang).slice(0, 2);
applyLanguage(initialLanguage);

if (languageSelect) {
  languageSelect.addEventListener("change", () => {
    const nextLang = languageSelect.value;
    localStorage.setItem("koda-language", nextLang);
    applyLanguage(nextLang);
  });
}

if (languageSelect && languageTriggers.length > 0) {
